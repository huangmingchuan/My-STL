...
namespace mystl
{
	...
	*/
	...
	private:
		...
		enum EMaxBytes { MAXBYTES = 128 };//小型区块的上界，超过的区块由malloc分配
	...
	public:
		...
		static void *reallocate(void *ptr, size_t old_size, size_t new_sz);
	};
	...
	//返回一个大小为n的对象，并且有时候会适当的为 free-list 增加节点
